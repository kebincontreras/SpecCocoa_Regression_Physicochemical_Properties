...
MODEL_DIR_DL = "model/Deep_Learning/NIR/"
MODEL_DIR_ML = "model/Machine_Learning/NIR/"
NORM_FACTORS = {
    'Cadmium': 5.6,
...
def load_best_dl_models(model_dir, num_bands, num_outputs, device):
    ...
    for file in os.listdir(model_dir):
        if file.endswith(".json"):
            ...
            for label in OUTPUT_LABELS:
                json_key = label.lower().replace(" ", "_")
    ...
    print("✅ Modelos DL por propiedad cargados.")
    return best_models
...
def load_best_ml_models(model_dir):
    ...
    print("✅ Modelos ML por propiedad cargados.")
    return best_models
...
def run_predictions():
    ...
    print("\n📊 Comparación por Lote (NIR - Machine Learning por propiedad)")
    print(tabulate(tabla_ml, headers=headers, tablefmt="grid"))

    print("\n📊 Comparación por Lote (NIR - Deep Learning por propiedad)")
