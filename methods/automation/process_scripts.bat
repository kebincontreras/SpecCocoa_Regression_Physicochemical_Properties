...
if exist "data\train_nir_cocoa_dataset.h5" if exist "data\test_nir_cocoa_dataset.h5" (
...
if exist "data\train_vis_cocoa_dataset.h5" if exist "data\test_vis_cocoa_dataset.h5" (
...
if exist "data\train_nir_cocoa_dataset_normalized.h5" if exist "data\test_nir_cocoa_dataset_normalized.h5" if exist "data\train_vis_cocoa_dataset_normalized.h5" if exist "data\test_vis_cocoa_dataset_normalized.h5" (
